        ...
        >
          ...
          <div className="flex-grow flex flex-col items-center justify-center pointer-events-none">
            ...
            <p className="text-base sm:text-lg text-gray-300 max-w-2xl leading-relaxed mb-10">
              BooTube ghosts profanity and blasphemy in real-time, delivering clean, family-friendly audio across your favorite streaming services.
            </p>
            <a 
          ...
          <div className="w-full max-w-5xl mx-auto mb-4 pointer-events-auto flex flex-col items-center gap-3">
            ...
            >
              <div className="animate-marquee flex items-center gap-10 md:gap-14 shrink-0 whitespace-nowrap">
                ...
                <a href="https://www.peacocktv.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gray-400 hover:text-[#00A8E1] font-bold tracking-tight text-lg md:text-xl transition-colors cursor-pointer">
                  <img src="/ic_peacock.svg" alt="Peacock" className="h-5 w-5 object-contain inline-block rounded" />
                  <span>Peacock</span>
                </a>
